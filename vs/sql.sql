...
-- Volcando estructura de base de datos para aepidemic-zombiedb
CREATE DATABASE IF NOT EXISTS `aepidemic-zombiedb` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `aepidemic-zombiedb`;

-- Volcando estructura para tabla aepidemic-zombiedb.ez_admin
...
-- Volcando estructura para tabla aepidemic-zombiedb.ez_users
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla aepidemic-zombiedb.ez_user_survivors
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla aepidemic-zombiedb.ez_voucher
